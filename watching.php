...
$watching = [
    [
        ...
        'resume' => 'Samurai Champloo opens in a small town where Fuu, working as a tea waitress, is harassed by the son of the town’s corrupt prefect. The outlaw Mugen arrives in town, and Fuu begs him for protection, which he gives in exchange for food. 
        <br>Meanwhile, the ronin Jin, also a new arrival, kills the prefect’s bodyguards when they abuse a peasant, ending up in conflict with Mugen when the latter mistakes him for one of the prefect’s men. The two’s fight ends up destroying the teahouse. 
        <br><br>The pair are captured and sentenced to death, but Fuu saves them. The pair attempt to restart their battle, but Fuu tosses a coin, saying if it lands on heads then the pair can continue their battle, but if it lands on tails they postpone their battle to help her find a samurai who smells of sunflowers, whom she has sought for years. 
    ...
    [
        ...
        <br><br>Fortunately, there exists a mysterious school of Jujutsu Sorcerers who exist to protect the precarious existence of the living from the supernatural!',
        'avis' => ''
        ],

            [
                'id' => 'SCCSN',
                'image' => '<img src="img/succession.jpg" alt="Succession card cover">',
                'titre' => 'Succession',
                ...
                [
                    'id' => 'Sntch',
                    'image' => '<img src="img/snatch.jpg" alt="Snatch card cover">',
                    'titre' => 'Snatch',
                    'description' => 'Movie - 1h44 of pure fun',
                    'note' => '5/5',
                    'review' => 'Thanks GOD for Guy Ritchie. Life would be way less funnier without this movie.',
                    'resume' => 'Turkish, an unlicenced boxing promoter is pulled into trouble when he becomes involved in big time criminal Brick Top, who wants him to arrange a fight and fix it. 
                    <br>Meanwhile, a diamond theft goes down but the 84 karat stone goes missing. This leads Avi, the boss who was supposed to receive the stone, to come to England to search for it, with the help of his cousin, Doug The Head and Bullet Tooth Tony. 
                    <br><br>As events twist and turn, the two situations blending into one with a chain reaction of events carrying on for each and each every character.',
                    'avis' => ''
                    ],

                    [
                        'id' => 'CODE-G',
                        'image' => '<img src="img/code-geass.jpg" alt="Code Geass card cover">',
                        'titre' => 'Code Geass',
                        ...
                        'resume' => 'After the invasion of Japan by the Brittannian Empire, the country is renamed to "Area 11". 
                        <br><br>The young Lelouch, a Brittannian student living in Japan, accidentally gets caught up in a local terrorist attack against Brittannia, reuniting with his childhood friend Suzaku as well as meeting the mysterious girl C.C. 
                        <br>Cornered in a life and death situation, Lelouch accepts a power C.C. offers to him, the ability to order anyone to do anything. 
                        <br><br>Harboring a thirst for revenge against the Brittanian Empire for their actions against his family, Lelouch wages war against the Empire. Using his newfound power and tactical ability, Lelouch goes under the alias Zero in attempts to fulfill his childhood vow, to destroy Brittannia!',
                        'avis' => ''
                        ],
                        ...
                        [
                            ...
                            'resume' => 'Dominic Cobb a unique con artist can enter anyone’s dreams and extract the most valuable ideas and secrets of people with the help of "inception" (a dream sharing technology) when the state of mind is at its vulnerable best. Cobb’s ability has made him the face of corporate spying, hence a wanted man too. 
                            ...
                            [
                                ...
                                'resume' => 'Elliot is a brilliant introverted young programmer who works as a cyber-security engineer by day and vigilante hacker by night. Suffering from a strange condition similar to schizophrenia, he tries to keep it under control in various ways. 
                                <br><br>When a strange young woman, Darlene, and a secretive man calling himself Mr. Robot – who claims to be the leader of an underground hacking group known as F-Society – offer him a chance to take his vigilantism to the next level and help them take down E-Corp – the corrupt multi-national financial company that he works for – Elliot finds himself at the crossroads. 
                                <br><br>After many twists and turns, Mr. Robot’s plan is finally put in motion - with catastrophic (un)intended results. But that’s just the end of the beginning of the real story.',
                                'avis' => ''
                                ],
